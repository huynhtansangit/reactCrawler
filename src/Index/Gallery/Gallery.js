            ...
            <section id="gallery-section">
                <div className="gallery-container text-center">
                    <div className="d-inline-block">
                        ...
                        <h2 className="text-left slogan-title text-uppercase" style={{ letterSpacing: '4px' }}>Let's enjoy yourself
            </h2>
                    </div>
                    <div className="row">
                    ...
                    <div id="image-tab-gallery" className="row gallery-tab">
                                ...
                                Object.keys(this.props.dataGallery).length === 0 ?
                                    ...
                                    (
                                        !this.props.dataGallery.error ?
                                            ...
                                            (this.props.dataGallery.imagesData.map((img, idx) =>
                                                <ImageItem itemSrc={img.url} key={idx} />))
                                            :
                                            // else: error occurred => Show pic 500
                                            (<img className="justify-item-center"
                                                src="https://bizflyportal.mediacdn.vn/bizflyportal/461/347/2020/06/02/22/54/nhi15910916872906.jpg" />)
                                    )
                            }
                        </div>
                        <div className="col-lg-3 col-md-3 col-sm-12 info-container offset-1"
                            style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif' }}>
                            {
                                ...
                                Object.keys(this.props.dataGallery).length === 0 ?
                                    (
                                        <UserInsta avatar="https://img.idesign.vn/2018/10/23/id-loading-1.gif" username="Loading"
                                            fullname="Loading" countPost="Loading" countFollowedBy="Loading" />) : (
                                        !this.props.dataGallery.error ?
                                            (
                                                <UserInsta avatar={this.props.dataGallery.userInsta.avatar}
